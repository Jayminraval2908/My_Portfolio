    ...
    <div className='text-white bg-gradient-to-b from-[#0f172a] to-[#1e293b]  flex justify-between w-full items-start p-10 md:p-20'>
        <div className='md:w-2/4 md:pt-10'>
            ...
            <p className='text-sm md:text-2xl tracking-tight'>
             I'm a passionate MERN STACK developer and Computer Engineering student, focused on building clean, responsive, and user-friendly web applications using modern technologies like React, Node, Express, MongoDB.
