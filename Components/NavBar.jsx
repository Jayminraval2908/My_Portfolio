...
function NavBar() {
  ...
  return (
    <nav className=' bg-gradient-to-r from-blue-600 via-purple-700 to-indigo-800 flex flex-wrap justify-between md:items-center text-white px-10 pt-6 md:px-20'>
